...
describe Fixnum do
  ...
  it "reads thousands" do
    ...
    17456.in_words.should == 'seventeen thousand four hundred fifty six'
  end

  it "read hundred thousands" do
    100_000.in_words.should == 'one hundred thousand'
    123_456.in_words.should == 'one hundred twenty three thousand four hundred fifty six'
  end
